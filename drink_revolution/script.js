...
const three = canvas ? createMainScene(canvas) : null;
const miniScenes = [];
let lenis = null;
...
function createMainScene(targetCanvas) {
  ...
  scene.fog = new THREE.FogExp2(0x0a0807, 0.032);
...
function getMainPixelRatio() {
  return Math.min(window.devicePixelRatio || 1, viewport.mobile ? 1.25 : 1.75);
}
