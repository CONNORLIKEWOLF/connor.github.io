(() => {
  ...
  intro
    .fromTo(".pinned--intro .pin-copy", { y: 90, opacity: 0.15 }, { y: 0, opacity: 1, duration: 0.28 }, 0)
    ...
    .to(".pinned--intro .pin-copy", { y: -70, opacity: 0.2, duration: 0.32 }, 0.72)
    .to(".pinned--intro .mask-frame", { clipPath: "inset(18% 7% 18% 7%)", scale: 0.88, opacity: 0.72, duration: 0.32 }, 0.72);
